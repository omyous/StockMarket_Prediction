...
from scrapping.data import binance_price
...
table_trace = go.Table(
    ...
    cells=dict(
        values=[binance_price().index[:], binance_price()['open'], binance_price()['high'], binance_price()['low'],
                binance_price()['close'], binance_price()['volume'], binance_price()['trade_number']],
